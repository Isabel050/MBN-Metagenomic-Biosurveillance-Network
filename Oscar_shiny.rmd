...
### The blue dot shows the median number of days and number of infections upon detection by Threat Net Israel, and error bars show the interquartile range. The grey lines show individual simulation runs.
```{r}
# set figure height
